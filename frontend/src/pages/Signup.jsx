...
const Signup = () => {
  const url =
    "https://img.freepik.com/premium-photo/glass-building-with-word-company-it_1295754-30727.jpg";
  ...
  return (
    <div>
      <div className={`h-[100vh] bg-[url('${url}')] bg-cover bg-center`}>
                      ...
                      <div className=" mt-4">
                        <label htmlFor="name" className="inp ">
                          <input
                            ...
                            required
                          />
                          <span className="label bg-white px-4">Name</span>
